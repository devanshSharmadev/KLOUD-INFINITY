...
import { SyncTableComponent } from './components/mainbody/bodyComponents/my-computers/sync-table/sync-table.component';
// import { ViewSyncFileComponent } from './components/mainbody/my-computers/sync-table/view-sync-file/view-sync-file.component';
import { DeskTopSynchingComponent } from './components/mainbody/bodyComponents/my-computers/desk-top-synching/desk-top-synching.component'
import {ViewSyncFileComponent} from './components/mainbody/bodyComponents/my-computers/sync-table/view-sync-file/view-sync-file.component';
import { DeleteConfirmComponent } from './components/mainbody/bodyComponents/mykloud/delete-confirm/delete-confirm.component';
import { LoginCredComponent } from './components/app-auth/login-cred/login-cred.component'
...
@NgModule({
  declarations: [
    ...
    SyncTableComponent,
    ViewSyncFileComponent,
    DeskTopSynchingComponent,
