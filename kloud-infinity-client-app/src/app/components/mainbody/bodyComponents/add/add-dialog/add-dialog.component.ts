...
export class AddDialogComponent implements OnInit {
  ...
  submitData(){
    ...
    this.http
    .post(`http://localhost:8081/api/${this.userToken.username}/single/upload`,formData,{headers:header,params:params})
  ...
  submitData2(){
    ...
    this.http
    .post(`http://localhost:8081/api/${this.userToken.username}/multiple/upload`,formData,{headers:header,params:params})
    .subscribe((response)=>{
      window.location.reload();
